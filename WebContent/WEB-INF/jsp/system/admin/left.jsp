		...
		<div id="sidebar" class="menu-min">
				...
				<div id="sidebar-shortcuts">
					...
					<div id="sidebar-shortcuts-large">
						...
						-->
						<button class="btn btn-small btn-warning" title="用户管理" id="adminzidian" onclick="zidian();"><i class="icon-book"></i></button>
						
						<button class="btn btn-small btn-danger" title="电影管理" id="adminmenu" onclick="menu();"><i class="icon-folder-open"></i></button>
